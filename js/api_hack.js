...
function loadSite() {
    $.ajax({
        ...
        url: '//api.football-data.org/v1/soccerseasons',
        dataType: 'json',
        type: 'GET',
...
function getLeague(leagueID) {
    $.ajax({
        headers: { 'X-Auth-Token': 'e34ad8f9aebb436eb3437851ca9b581a' },
        url: '//api.football-data.org/v1/soccerseasons/' + leagueID + '/leagueTable',
        dataType: 'json',
        type: 'GET',
    }).done(function(response) {
...
function getTeam(teamID) {
    $.ajax({
        headers: { 'X-Auth-Token': 'e34ad8f9aebb436eb3437851ca9b581a' },
        url: '//api.football-data.org/v1/teams/' + teamID,
        dataType: 'json',
        type: 'GET',
    }).done(function(response) {
        $('.results').html('');
...
function getPlayer(teamID) {
    $.ajax({
        headers: { 'X-Auth-Token': 'e34ad8f9aebb436eb3437851ca9b581a' },
        url: '//api.football-data.org/v1/teams/' + teamID + '/players',
        dataType: 'json',
        type: 'GET',
    }).done(function(response) {
...
function getHighlight(searchTerm) {
    $.ajax({
        ...
        $.each(results.items, function(key, value) {
            html += '<a href="' + '//www.youtube.com/embed/' + value.id.videoId + '" target="iframe_a">' +
